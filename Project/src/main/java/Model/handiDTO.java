...
public class handiDTO {
	...
	/*
	 CREATE TABLE t_handicaped
(
    h_seq             NUMBER(12, 0)    NOT NULL, 
    h_name            VARCHAR2(30)     NOT NULL, 
    h_relationship    VARCHAR2(30)     NOT NULL, 
    h_birthdate       DATE             NOT NULL, 
    h_addr            VARCHAR2(200)    NOT NULL, 
    h_gender          CHAR(1)          NOT NULL, 
    h_phone           VARCHAR2(30)     NOT NULL, 
